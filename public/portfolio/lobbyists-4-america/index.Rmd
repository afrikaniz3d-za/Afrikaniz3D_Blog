...
An [article](https://genflow.com/blogs/how-the-twitter-algorithm-works-in-2023#:~:text=Likes%20are%20more%20important%20than,or%20Replies%20(1x%20boost) by Molly Rees on [Genflow](https://genflow.com/) shared some surprising nuggets of information when it came to changes in the algorithm (in 2023) that are worth looking into in general.  
